...
const baseClasses =
  "w-full px-4 rounded-lg border border-gray-200 bg-gray-50/50 dark:bg-gray-800/80 dark:text-gray-200 dark:border-gray-600 focus:ring-1 focus:ring-green-500/40 focus:border-green-400";
